...
<div class="text">Data Transaksi</div>
   ...
   <div class="accordion">
    <div>
      ...
      <label for="section1" class="accordion__label">Data Transaksi Ibu Siska</label>
      <div class="accordion__content">
        <p>Data Transaksi Siska</p>
    ...
    <div>
      ...
      <label for="section2" class="accordion__label">Data Transaksi Ibu Ratna</label>
      <div class="accordion__content">
        <p>Data Transaksi Ibu Ratna</p>
        <table class="styled-table">
          <thead>
              <tr>
                  <th>No</th>
    ...
    <div>
      ...
      <label for="section3" class="accordion__label">Data Transaksi Pak Ahmad</label>
      <div class="accordion__content">
        <p>Data Transaksi Pak Ahmad</p>
        <table class="styled-table">
          <thead>
              <tr>
                  <th>No</th>
