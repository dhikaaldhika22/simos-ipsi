...
<body>
  ...
  <section class="home-section">
    <div class="text"><a href="/stok"><i class="fas fa-chevron-left"></i></a>Edit Data</div>
    <div class="containerTambah">
      <form action="/updateStok/{{ $dataStok  ->id }}" method="POST">
        @csrf
        <div class="wrapper">
          <div class="title">
            Edit Data Stok
          ...
          <div class="form">
             <div class="inputfield">
                ...
                <input type="text" value="{{ $dataStok->nama_barang }}" name="nama_barang" class="input">
             </div>  
             <div class="inputfield">
              <label>Kondisi</label>
              <div class="custom_select">
                <select name="kondisi">
                  <option value="{{ $dataStok->kondisi }}">Kondisi</option>
              ...
              <div class="inputfield">
                ...
                <input type="text" value="{{ $dataStok->kategori_barang }}" name="kategori_barang" class="input">
             </div>  
             <div class="inputfield">
                <label>Kode Stok</label>
                <input type="text" value="{{ $dataStok->kode_barang }}" name="kode_barang" class="input">
             </div>  
            <div class="inputfield">
