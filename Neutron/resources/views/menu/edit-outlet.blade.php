...
<body>
  ...
  <section class="home-section">
    <div class="text"><a href="/outlet"><i class="fas fa-chevron-left"></i></a>Edit Data</div>
    <div class="containerTambah">
      <form action="/updateOutlet/{{ $dataOutlet->id }}" method="POST">
        @csrf
        <div class="wrapper">
          <div class="title">
            Edit Data Outlet
          ...
          <div class="form">
             <div class="inputfield">
                ...
                <input type="text" value="{{ $dataOutlet->outlet_name }}" name="outlet_name" class="input">
             </div>  
             <div class="inputfield">
              <label>Kota</label>
              <input type="text" value="{{ $dataOutlet->kota }}" name="kota" class="input">
            </div> 
              <div class="inputfield">
                <label>Alamat Outlet</label>
                <input type="text" value="{{ $dataOutlet->alamat }}" name="alamat" class="input">
             </div>  
             <div class="inputfield">
                <label>Alamat Email Outlet</label>
                <input type="text" value="{{ $dataOutlet->outlet_email }}" name="outlet_email" class="input">
             </div>  
            <div class="inputfield">
