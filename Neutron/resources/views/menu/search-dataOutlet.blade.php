...
<form action="{{ 'searchOutlet' }}" method="get">
    <input type="search" class="form-control form-control-dark" placeholder="Cari berdasarkan Nama" name="query-outlet" aria-label="Search">
</form>
...
<div class="container-profile">
    ...
    <div class="box">
        ...
        <div class="image">
          ...
          <div class="name-profile">{{ $outlett-> outlet_name }}</div>
                <p class="title">{{$outlett -> kota  }}</p>
                <p class="data">{{ $outlett -> alamat }}</p>
                <p class="data">{{ $outlett-> outlet_email }}</p>
      </div>
    @endforeach
