...
<div class="page-header">
    <div class="col-auto float-right ml-auto">
        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i> Tambah Data</a>
    </div>
</div>
<!-- End of Page Header -->
...
<form action="{{ 'search' }}" method="get">
    <input type="search" class="form-control form-control-dark" placeholder="Cari berdasarkan Nama" name="query" aria-label="Search">
</form>
    ...
    <div class="box">
        ...
        <div class="image">
          ...
          <div class="name-profile">{{ $user-> name }}</div>
                <p class="title">{{$user -> employee  }}</p>
                <p class="data">{{ $user -> no_hp }}</p>
