...
<div class="text">Data Transaksi</div>
   ...
   <div class="accordion">
    <div>
      ...
      <label for="section1" class="accordion__label">Data Transaksi Ibu Rini</label>
      <div class="accordion__content">
        <p>Data Transaksi Ibu Rini</p>
    ...
    <div>
      ...
      <label for="section2" class="accordion__label">Data Transaksi Ibu Erna</label>
      <div class="accordion__content">
        <p>Data Transaksi Ibu Erna</p>
        <table class="styled-table">
          <thead>
              <tr>
                  <th>No</th>
    ...
    <div>
      ...
      <label for="section3" class="accordion__label">Data Transaksi Pak Subhan</label>
      <div class="accordion__content">
        <p>Data Transaksi Pak Subhan</p>
        <table class="styled-table">
          <thead>
              <tr>
                  <th>No</th>
