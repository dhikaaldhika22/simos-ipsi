...
<body>
  ...
  <section class="home-section">
    <div class="text"><a href="{{ 'stok' }}"><i class="fas fa-chevron-left"></i></a>Tambah Data</div>
        ...
        <div class="wrapper">
          ...
          <div class="form">
             <div class="inputfield">
                ...
                <input type="text" name="nama_barang" class="input">
             </div>  
             <div class="inputfield">
              <label>Kondisi</label>
              ...
              <div class="inputfield">
                ...
                <input type="text" name="kategori_barang" class="input">
             </div>  
             <div class="inputfield">
                <label>Kode Stok</label>
                <input type="text" name="kode_barang" class="input">
             </div>  
            <div class="inputfield">
