...
<body>
  ...
  <section class="home-section">
    ...
    <div class="containerTambah">
      ...
      <form action="/updateJamal/{{ $dataJamal->id }}" method="POST">
        @csrf
        <div class="wrapper">
          <div class="title">
            Edit Data Karyawan
          ...
          <div class="form">
             <div class="inputfield">
                <label>No</label>
                <input type="text" value="{{ $dataJamal->id }}" name="id" class="input">
             </div>  
             <div class="inputfield">
              <label>Keterangan</label>
              <input type="text" value="{{ $dataJamal->keterangan }}" name="keterangan" class="input">
           </div> 
              <div class="inputfield">
                <label>Jumlah</label>
                <input type="text" value="{{ $dataJamal->jumlah }}" name="jumlah" class="input">
             </div>  
             <div class="inputfield">
                <label>Harga</label>
                <input type="text" value="{{ $dataJamal->harga }}" name="harga" class="input">
             </div>
             <div class="inputfield">
              <label>Total</label>
              <input type="text" value="{{ $dataJamal->total }}" name="total" class="input">
           </div>  
            <div class="inputfield">
