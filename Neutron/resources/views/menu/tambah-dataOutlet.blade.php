...
<body>
  ...
  <section class="home-section">
    <div class="text"><a href="{{ 'outlet' }}"><i class="fas fa-chevron-left"></i></a>Tambah Data</div>
    <div class="containerTambah">
      <form action="/insertOutlet" method="POST">
        @csrf
        <div class="wrapper">
          <div class="title">
            Tambah Data Outlet
          ...
          <div class="form">
             <div class="inputfield">
                ...
                <input type="text" name="outlet_name" class="input">
             </div>  
             <div class="inputfield">
              <label>Kota</label>
             ...
             <div class="inputfield">
                ...
                <input type="text" name="outlet_email" class="input">
             </div>  
            <div class="inputfield">
